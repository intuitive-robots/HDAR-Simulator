...
class BimanualPutIteminDrawSimulator(SFSimulator):
    ...
    def after_step(self):
        ...
        self.mj_scene,
        target_pairs1={('picked_item', 'finger1_rb1_tip_collision')},
        target_pairs2={('picked_item', 'finger2_rb1_tip_collision')}
        )
...
#left hand pick the assembly
    ...
    def reset(self):
        ...
        self.pick_robot1.gotoCartPositionAndQuat(
            desiredPos=[self.picked_Box.pos[0], self.picked_Box.pos[1], 0.2],
            desiredQuat=[0, 1, 0, 0],
            duration=2.0,
        )
        ...
        self.pick_robot2.gotoCartPositionAndQuat(
            desiredPos=[self.target_Box.pos[0], self.target_Box.pos[1], 0.2],
            desiredQuat=[0, 1, 0, 0],
            duration=2.0,
        )
...
if __name__ == '__main__':
    simulator = BimanualPutIteminDrawSimulator()
    simulator.run()
